...
tick_labels = [f'{month_names[month-1]}-{year}' for year in range(start_year, end_year + 1) for month in range(start_month, end_month + 1)]

variables = {
    'NZ_Product_NH': (timeNZ_product_NH, timeNZ_product_NH_normalized, 'blue'),
    'RFW_Product_NH': (timeRFW_product_NH, timeRFW_product_NH_normalized, 'green'),
    'IV_Product_NH': (timeIV_product_NH, timeIV_product_NH_normalized, 'red'),
    'NZS_Product_NH': (timeNZS_product_NH, timeNZS_product_NH_normalized, 'purple'),
}
