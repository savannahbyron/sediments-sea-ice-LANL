...
if os.path.exists(pickle_filename):
    ...
    sum_over_months = np.zeros((12, nCells))  # 12 months, nCells long
    ...
    for month in months:
        ...
        if os.path.exists(filepath):
            ...
            if os.path.exists(output_filepath):
                ...
                var1D_sum = np.sum(var1[:, NHindices, 0:7], axis=(1, 2))  # Sum over NHindices and first 7 time steps
...
ax.set_title('Sum of NZaerosol over Months')
