...
timeBC1_product_NH_normalized = normalize(timeBC1_product_NH[:, 1])
timeBC1_product_SH_normalized = normalize(timeBC1_product_SH[:, 1])
timeBC2_product_NH_normalized = normalize(timeBC2_product_NH[:, 1])
timeBC2_product_SH_normalized = normalize(timeBC2_product_SH[:, 1])
timeDust_product_NH_normalized = normalize(timeDust_product_NH[:, 1])
timeDust_product_SH_normalized = normalize(timeDust_product_SH[:, 1])
...
# Plot NH data
axs[0].plot(timeBC1_product_NH[:, 0], timeBC1_product_NH_normalized, label='Black Carbon 1 NH')
axs[0].plot(timeBC2_product_NH[:, 0], timeBC2_product_NH_normalized, label='Black Carbon 2 NH')
axs[0].plot(timeDust_product_NH[:, 0], timeDust_product_NH_normalized, label='Dust NH')
axs[0].set_title('Northern Hemisphere Vertical Profile')
axs[0].legend()

# Plot SH data
axs[1].plot(timeBC1_product_SH[:, 0], timeBC1_product_SH_normalized, label='Black Carbon 1 SH')
axs[1].plot(timeBC2_product_SH[:, 0], timeBC2_product_SH_normalized, label='Black Carbon 2 SH')
axs[1].plot(timeDust_product_SH[:, 0], timeDust_product_SH_normalized, label='Dust SH')
...
plt.tight_layout()
plt.savefig('VerticalProfileNH_SH_Products_Normalized.png')
plt.show()
