...
timeFW_product_NH_normalized = normalize(timeFW_product_NH[:, 1])
timeFW_product_SH_normalized = normalize(timeFW_product_SH[:, 1])
...
axs[0].plot(timeFW_product_NH[:, 0], timeFW_product_NH_normalized, label='FW Product NH')
...
axs[1].plot(timeFW_product_SH[:, 0], timeFW_product_SH_normalized, label='FW Product SH')
...
plt.tight_layout()
plt.savefig('NH_SH_Products_Normalized.png')
plt.show()
